...
class MSSQLDatabase(object):
    ...
    def insert_table(
        ...
        for column in df.columns.tolist():
            if column in ["timestamp_created_utc", "ishares_date", "weight"]:
                continue
            ...
            if column in [
                ...
                custom[column] = "varchar(3)"

            elif column in ["country_iso2"]:
                custom[column] = "varchar(4)"

            else:
                custom[column] = "varchar(50)"
